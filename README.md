...
## Introduction
We propose the multi-view item network (MVIN), a GNN-based rec-ommendation model which provides superior re-commendations bydescribing items from a unique mixed view from user and entity angles.
