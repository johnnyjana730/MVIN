...
def parse_args():
    ...
    parser.add_argument('--save_path', nargs='?', default='../model/KGAT/',
    ...
    # parser.add_argument('--loss_type', nargs='?', default="" help='save path log_name')
    parser.add_argument('--loss_type',  nargs='?', default='cross_entropy',
                        help='Number of epoch.')
    parser.add_argument('--n_memory', type=int, default=0,
                        help='0: n_memory')
    parser.add_argument('--item_update_mode', nargs='?', default="", help='item_update_mode')
    parser.add_argument('--using_all_hops', nargs='?', default="", help='item_update_mode')
    parser.add_argument('--load_pretrained_emb', type=bool, default=False,
                        help='load_pretrained_emb')
    parser.add_argument('--save_final_emb', type=bool, default=False,
                        help='save_final_emb')
    parser.add_argument('--restore_best_and_save_weight', type=bool, default=True,
                        help='restore_best_and_save_weight')
