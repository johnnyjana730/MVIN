...
class NFM(object):
    ...
    def _build_inputs(self):
        ...
        self.labels = tf.placeholder(dtype=tf.float32, shape=[None], name='labels')
            ...
            # model.i_indices:  i_indices,
            # model.i_values: i_values,
            # model.i_shape: i_shape,

        self.i_indices = tf.placeholder(tf.int64, shape=[None, 2], name='pos_indices')
        self.i_values = tf.placeholder(tf.float32, shape=[None], name='pos_values')
        self.i_shape = tf.placeholder(tf.int64, shape=[2], name='pos_shape')
        ...
        self.sp_i_feats = tf.SparseTensor(self.i_indices, self.i_values, self.i_shape)
    ...
    def _build_model(self):
        # self.batch_predictions = self._get_bi_pooling_predictions(self.sp_i_feats)
        self.scores =  self._get_bi_pooling_predictions(self.sp_i_feats)
    ...
    def _build_loss(self):
        ...
        # pos_scores = self._get_bi_pooling_predictions(self.sp_i_feats)
