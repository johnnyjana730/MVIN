    ...
    with tf.Session(config=config) as sess:
        ...
        for step in range(args.n_epochs):
            ...
            while start + args.batch_size <= train_data.shape[0]:
                ...
                if show_loss:
                    print('start = ', start, 'loss = ', loss, 'l2_loss', l2_ls_loss,end= '\r')
            ...
            if show_topk:
                ...
                if early_st_info.update_score(step, n_precision_eval[2], sess, model, saver) == True: break
